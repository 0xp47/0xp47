...
def get_event_embed(event_name, event_data):
    ...
    if event_name == "issues":
        ...
        embed["color"] = (
            15158332 if action == "opened" else 9807270
        )  # Red for opened, grey for closed
        ...
        if action == "closed" and merged:
            ...
            embed["color"] = (
                3066993 if action == "opened" else 15158332
            )  # Green for opened, Red for closed
        ...
        embed["url"] = repo_url
        embed["description"] = (
            f"**{sender}** starred the repository **[{repo_name}]({repo_url})**! Thank you!"
        )
